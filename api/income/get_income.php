...
Returns a JSON object with income sources for the authenticated user.
*/
...
if ($_SERVER["REQUEST_METHOD"] === "POST" || $_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    $sql = "SELECT i.*, c.name as category_name, cur.name as currency_name, cur.symbol as currency_symbol 
            FROM income i 
